...
<div class="dropdown" style="margin-left: 15%;">
  ...
  <div class="dropdown-content">
    <h1 style="margin-left:5px; margin-right:5px; border-bottom:solid 1px #cccccc; font-family:'TimeNewRoman';"><b>SHOP<b></h1>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <h1 style="margin-left:5px; margin-right:5px; border-bottom:solid 1px #cccccc; font-family:'TimeNewRoman';"><b>DESIGNER<b></h1>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <h1 style="margin-left:5px; margin-right:5px; border-bottom:solid 1px #cccccc; font-family:'TimeNewRoman';"><b>SERVICE<b></h1>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <h1 style="margin-left:5px; margin-right:5px; border-bottom:solid 1px #cccccc; font-family:'TimeNewRoman';"><b>BOARD<b></h1>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <h1 style="margin-left:5px; margin-right:5px; border-bottom:solid 1px #cccccc;font-family:'TimeNewRoman';"><b>Q&A<b></h1>
...
<!-- <div class="menus"><a href="./intro/intro.php"><img src="./img/shop.gif" border="0"></a></div>
<div class="menus"><a href="./intro/dintro.php"><img src="./img/designer.gif" border="0"></a></div>
<div class="menus"><a href="./service/serviceintro.php"><img src="./img/service.gif" border="0"></a></div>
<div class="menus"><a href="./free/list.php"><img src="./img/board.gif" border="0"></a></div>
<div class="menus"><a href="./qna/list.php"><img src="./img/q&a.gif" border="0"></a></div>
<div class="menus"><a href="#"><img src="./img/survey.gif" onclick="window.open('./survey/survey.php', '','scrollbars=no, toolbars=no,width=180,height=230')" border="0"></a></div> -->
