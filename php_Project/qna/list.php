...
<div id="wrap">
  ...
  <div id="content">
	<div id="col1">
		<div id="left_menu">
<?
			include "../lib/left_menu_qa.php";
?>
		</div>
	</div>

	<div id="col2">
		<img src=../img/reserhello.jpg>
		...
		<div id="list_search">
			...
			<div id="list_search5"><button class="button">검색</button></div>
		</div>
		</form>
		<div class="clear"></div>
		<img src="../img/boardbar.jpg">
...
<?
	...
	{
?>
		<a href="write_form.php?table=<?=$table?>"><button class="button">글쓰기</button></a>
<?
	}
?>
				</div>
